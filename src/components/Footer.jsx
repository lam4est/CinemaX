  ...
  return (
    <footer className="flex flex-col items-center justify-around w-full py-16 text-sm text-gray-800/70">
                <div className="flex items-center gap-8">
                    <a href="#" className="font-medium text-gray-300 hover:text-gray-100 transition-all">
                        Home
                    </a>
                    <a href="#" className="font-medium text-gray-300 hover:text-gray-100 transition-all">
                        About
                ...
                <p className="mt-8 text-center text-gray-300">Copyright © 2025 CinemaX - All rights reservered.</p>
            </footer>
  )
}

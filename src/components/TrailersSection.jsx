...
const TrailersSection = () => {
    ...
    console.log(dummyTrailers[2]);
    console.log(currentTrailer.videoUrl);

  return (
    <div className='px-6 md:px-16 lg:px-24 py-20 xl:px-44 overflow-hidden'>
        ...
        <div className='relative mt-6'> 
            ...
            <ReactPlayer 
                ...
                // playing={true}
                controls={false}
                className='mx-auto max-w-full zindex-10 rounded-lg overflow-hidden'
            />
        </div>
